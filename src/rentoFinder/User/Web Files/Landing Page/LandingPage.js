...
import { NearbyListings } from "../../Components/LandingPage/Rooms/NearbyListings";
import { Video } from "../../Components/Video/RoomVideo";
import { ButtonAndHeadingText } from "../../Components/LandingPage/ButtonAndHeadingText/ButtonAndHeadingText";
import { NewRooms } from "../../Components/LandingPage/NewRooms/NewRooms";
  ...
  return (
    <Stack>
      ...
      <Box>
        ...
        >
          We are Bihar's #1 platform for renting rooms and flats! With the
          largest network of property listings, we make it easy to find your
          perfect rental - no more wandering streets or dealing with local
          agents. Enjoy a hassle-free experience and find exactly what you need,
          all in one place!
        </Typography>
        ...
        >
          ...
          <SelectTextField select label="Property Status">
      ...
      {/* Featured Listings */}
      <ButtonAndHeadingText headingText="Featured Listings" />

      {/* Apartments */}
      <RoomsTabs />

      {/* Nearby Listings with button */}
      <ButtonAndHeadingText headingText="Nearby Listings" />
