      ...
      >
        ...
        >
          <List sx={{ listStyleType: "disc", pl: 2, py: 0 }}>
            <ListItem
              sx={{ display: "list-item", listStyleType: "disc", p: 0, py: 0 }}
            >
              <ListItemText
                primary={
        ...
        >
          <CameraAltIcon />
          <Typography variant="body1">{noOfPhotos}</Typography>
        </Box>
        ...
        >
          <LocalMoviesIcon />
          <Typography variant="body1">{noOfVideos}</Typography>
        </Box>
        ...
        <Typography
          variant="body1"
          sx={{ color: "#FF5A3C", pl: "15px", m: "10px 0" }}
        >
          ${price}/Month
        </Typography>
        ...
        <Typography
          variant="body2"
          sx={{ color: "#5C727D", pl: "15px", mt: "20px" }}
        >
          {description1}
        </Typography>
        ...
        <Typography
          variant="body2"
          sx={{ color: "#5C727D", pl: "15px", mt: "5px" }}
        >
          {description2}
        </Typography>
        ...
        >
          ...
          <Box sx={{ display: "flex", flexDirection: "row" }}>
            <Typography variant="body1" sx={{ mt: "0px" }}>
              {bedrooms}
            </Typography>
            {/* <BedIcon />
          ...
          {/* Area icon */}
          <Box sx={{ display: "flex", flexDirection: "row" }}>
            <Typography variant="body1" sx={{ mt: "1px", mr: "-25px" }}>
              {area}
            </Typography>

            <Box sx={{ display: "flex", flexDirection: "column" }}>
              <CropSquareIcon sx={{ ml: "25px" }} />{" "}
              {/* Area icon (Change it later)*/}
              <List sx={{ listStyleType: "disc", p: 0 }}>
                <ListItem sx={{ display: "list-item", p: 0, ml: "8px" }}>
