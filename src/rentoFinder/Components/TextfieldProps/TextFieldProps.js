import { Container, Divider, Stack, TextField, Typography,Box, Button } from "@mui/material"
...
// Props component
export const SignInAndLogInProps = ({heading1,heading2, headingHelper,  fields, buttonText,rightSideBoxText,textUnderButton}) => {
    return(
        <Stack>
            {/* Navbar component */}
            <Navbar />
            ...
            <Container
                ...
                <Box sx={{
                    ...
                    {/* Second TextField */}
                    {fields.length > 0 ? (fields.map((field) => ( <TextField 
                        required
                        variant="outlined" 
                        label={field.label}
                ...
                <Divider orientation="vertical" variant="middle" sx={{mt: '50px'}} flexItem/>
