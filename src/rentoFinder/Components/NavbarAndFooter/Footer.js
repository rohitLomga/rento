        ...
        <Stack>
            ...
            <Container maxWidth='large'
                ...
                <StyledBox>
                    ...
                    <Box sx={{display: 'flex', alignItems: 'baseline', marginLeft: '12px'}}>
                        <img src={homeIcon} />
                        <Typography variant="h5" sx={{ fontFamily: 'Poor Story', fontSize: '36px', fontWeight: 'lighter'}}>
                            Rentofinder
                        </Typography>
                    ...
                    <FirstRow variant="body2" sx={{mt: '12px'}}>
                        Bihar's top choice for room and flat rentals! Find your perfect home hassle-free with the largest property listings-all in one place, no street roaming required.
                    </FirstRow>
                    ...
                    {/* Icons */}
                    <Box sx={{margin: '10px 0 0 20px', display: 'flex',width: '50%', justifyContent: 'space-between', mb: '20px'}}>

                        {/* Icon style is not working */}
                        <FacebookRoundedIcon sx={{color: 'white', backgroundColor: '#171B2A'}}/>  {/* Facebook icon */}
                ...
                <StyledBox>
                    ...
                    <FormControl variant="outlined" sx={{m: 1.3, mt: 3, width: '35ch', backgroundColor: 'white'}}>
            ...
            <Container maxWidth='large'
                ...
                <Box>
                    <Typography variant="body1">All Rights Reserved @ Company 2024</Typography>
                </Box>
